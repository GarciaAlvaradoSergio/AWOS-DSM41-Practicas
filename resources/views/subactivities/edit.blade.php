    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="text-center">
          <form class="row g-3" action="{{ route('subactivities.update', $subactivity->id) }}" method="post">
            {!! csrf_field() !!}
            @method('PUT')
            <div class="col-md-12">
              <label for="inputEmail4" class="form-label">Nombre</label>
              <input type="text" name="nombre" class="form-control" id="inputEmail4" value="{{$subactivity->nombre}}" autofocus required>
            </div>
            <div class="col-md-6">
              <label for="inputPassword4" class="form-label">Fecha</label>
              <input type="date" name="created_at" class="form-control" id="inputPassword4" value="{{$subactivity->created_id}}" required>
            </div>
            <div class="col-6">

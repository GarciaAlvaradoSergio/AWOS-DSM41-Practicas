    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <div class="text-center">
          <form class="row g-3" action="{{ route('activities.update', $activity->id)   }}" method="post">
            {!! csrf_field() !!}
            @method('PUT')
            <div class="col-md-12">
              <label for="inputEmail4" class="form-label">Titulo</label>
              <input type="text" name="titulo" class="form-control" id="inputEmail4" autofocus value="{{$activity->titulo}}">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
              <a class="btn btn-danger m-3" href="/activities">Cancelar</a>
